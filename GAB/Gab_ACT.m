function S = Gab_ACT(x, N_FFT, L, gamma_K, CR, method)
...
%  gamma_K - threshold applied on inifinte Gaussian window values (default: 10^(-4))
...
if strcmp(method, 'ptByPt')
    for n = 1:x.N
        ...
        k = ((-k_min):k_max).';
        w = Gab_Gaussian_Window(k, L(n), 0, 0, CR(n));
        for m = 1:N_FFT
